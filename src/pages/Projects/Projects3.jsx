             ...
             <Container>
                <div className="md:flex items-center gap-10">
                    ...
                    <div className='md:w-[50%]'>
                        ...
                        <div className="md:flex  md:gap-12 py-7 space-y-2 md:space-y-0">
                            <div>
                                <a className="flex md:justify-center items-center gap-2 hover:text-green-700  hover:scale-105 duration-300"  href="https://brand-shop-af581.web.app/" target="new">
                                <p>Live Demo </p>
                                <FiExternalLink className="inline-flex"></FiExternalLink> 
                                </a>
                            </div>
                            <div>
                                <a className="flex md:justify-center items-center gap-2 hover:text-green-700  hover:scale-105 duration-300" href='https://github.com/Shamimreza82/brand-shop-client-A10' target='new' >
                                    <p className="hover:text-green-700 ">Clint Side Code Link</p>
                                    <FaGithub className="inline-flex "></FaGithub> 
                                </a>    
                            </div>
                            <div>
                                <a className="flex md:justify-center items-center gap-2 hover:text-green-700  hover:scale-105 duration-300" href='https://github.com/Shamimreza82/brand-shop-server-A10' target='new'>
